...
def fixme(msg: str) -> None: ...
def memdump(msg: str, data: bytes, len: int) -> None: ...
...
class Caps(MiniObjectMixin, GObject.GBoxed):
    ...
    def __new__(cls, *args: Union[Structure, str, Caps]): ...
...
class Structure(GObject.GBoxed):
    ...
    def __new__(cls, *args: Union[str, Structure], **kwargs: Any): ...
    def __enter__(self) -> Self: ...
    def __exit__(
        self, _type, _value, _tb
    ): ...  # FIXME: Override is missing typing annotation
